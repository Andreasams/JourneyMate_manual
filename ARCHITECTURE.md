...
- [ ] **Typography from AppTypography** — No inline `TextStyle(...)`. Use `AppTypography.h1`, `AppTypography.body`, `AppTypography.bodySm`, etc. (23-style scale: hero, h1/h2/h3/h4/h5/h6, bodyLg/bodyLgMedium/bodyLgHeavy/body/bodyLight/bodyMedium/bodyHeavy/bodyExtraHeavy/bodySm/bodySmMedium/bodySmHeavy, button, price). Note: `bodyHeavy` is w600, `bodyExtraHeavy` is w700.
  - See [Design Token System](#design-token-system) (lines 1116-1127)
