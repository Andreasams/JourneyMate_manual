...
/// Main entry point with full Riverpod 3.x infrastructure + comprehensive error logging
void main() async {
  // Wrap entire app in error handlers to catch grey screen exceptions in release mode
  runZonedGuarded(() async {
    WidgetsFlutterBinding.ensureInitialized();

    // ⚠️ CRITICAL: Capture Flutter framework errors (widget build errors, layout errors)
    ...
    // ⚠️ CRITICAL: Capture platform errors (native iOS/Android crashes, async errors outside Flutter)
    ...
    // ⚠️ CRITICAL: Capture uncaught async errors (Futures, Streams, isolate errors)
    // ignore: avoid_print
    print('═══════════════════════════════════════════════════════════');
    // ignore: avoid_print
    print('🔴 ZONE ERROR (Uncaught Async): $error');
    // ignore: avoid_print
    print('📚 STACK TRACE:\n$stack');
    // ignore: avoid_print
    print('═══════════════════════════════════════════════════════════');
