...
class _RestaurantShimmerWidgetState extends State<RestaurantShimmerWidget> {
  ...
  /// Section spacing
  static const double _logoToOkLineSpacing = 16.0;
  static const double _okLineToGallerySpacing = 24.0;
  static const double _galleryTitleToTabsSpacing = 16.0;
  static const double _tabsToImagesSpacing = 16.0;
  static const double _galleryToMenuSpacing = 24.0;
  static const double _menuTitleToButtonsSpacing = 16.0;
