...
///
/// Features: - Displays a horizontal list of topic buttons - Highlights
/// selected topic - Localized labels via translation system - Automatic
/// rebuild when translations change - Triggers callback with selected label
/// when topic is chosen
class UserFeedbackButtonsTopic extends StatefulWidget {
  ...
  @override
  State<UserFeedbackButtonsTopic> createState() =>
      _UserFeedbackButtonsTopicState();
}

class _UserFeedbackButtonsTopicState extends State<UserFeedbackButtonsTopic> {
  // --- State ---
  ...
  @override
  void didUpdateWidget(UserFeedbackButtonsTopic oldWidget) {
  ...
  /// Gets all localized topic labels
