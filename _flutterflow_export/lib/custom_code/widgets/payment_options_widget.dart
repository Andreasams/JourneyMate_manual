...
/// A widget that displays payment options as filterable buttons.
///
/// Features: - Displays payment methods in a custom ordered layout -
/// Auto-calculates required height based on content wrapping - Highlights
/// selected payment filters - Supports card types, digital wallets, cash, and
/// other features - Excludes parent card category from display
...
class _PaymentOptionsWidgetState extends State<PaymentOptionsWidget> {
  ...
  static const Color _selectedBackgroundColor = Color(0xFFFDF2EC);
  static const Color _unselectedBackgroundColor = Color(0xFFf2f3f5);
  static const Color _selectedTextColor = Color(0xFFD35400);
  ...
  /// Handles changes to filters or container width
  void _handlePropChanges(PaymentOptionsWidget oldWidget) {
    final filtersChanged = _haveFiltersChanged(oldWidget);
    final widthChanged = _hasWidthChanged(oldWidget);
