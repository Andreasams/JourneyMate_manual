...
abstract class FlutterFlowTheme {
  ...
  late Color businessIsOpenGreen;
...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFFE9874B);
  late Color secondary = const Color(0xFFFFFFFF);
  late Color tertiary = const Color(0xFFEE8B60);
  late Color alternate = const Color(0xFF518751);
  late Color primaryText = const Color(0xFF14181B);
  late Color secondaryText = const Color(0xFF57636C);
  late Color primaryBackground = const Color(0xFFFFFFFF);
  late Color secondaryBackground = const Color(0xFFF2F3F5);
  ...
  late Color businessIsOpenGreen = const Color(0xFF518751);
}
