                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Row(
                                      children: [
                                        Text(
                                          _restaurant['statusOpen'] as bool
                                            ? getTranslations(widget.languageCode, 'business_status_open', widget.translationsCache)
                                            : getTranslations(widget.languageCode, 'business_status_closed', widget.translationsCache),
                                        ...
                                        SizedBox(width: 7),
                                        Text(
                                          '${getTranslations(widget.languageCode, 'business_status_until', widget.translationsCache)} ${_restaurant['closingTime']}',
                                          style: AppTypography.bodySmall.copyWith(
                                            fontWeight: FontWeight.w400,
                                            color: AppColors.textPlaceholder,
                                          ),
                    ...
                    Padding(
                      ...
                      child: Center(
                        child: TextButton(
                          ...
                          child: Text(
                            getTranslations(widget.languageCode, 'report_incorrect_info', widget.translationsCache),
                            style: AppTypography.bodySmall.copyWith(
...
class _QuickActionButtons extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    // Get language code and translations cache from parent page
    final parentState = context.findAncestorStateOfType<_BusinessProfilePageState>();
    final languageCode = parentState?.widget.languageCode ?? 'da';
    final translationsCache = parentState?.widget.translationsCache;

    final actions = [
      if (phone != null) {'label': getTranslations(languageCode, 'quick_action_call', translationsCache), 'icon': Icons.phone_outlined},
      {'label': getTranslations(languageCode, 'quick_action_website', translationsCache), 'icon': Icons.language_outlined},
      {'label': getTranslations(languageCode, 'quick_action_book_table', translationsCache), 'icon': Icons.calendar_today_outlined},
      {'label': getTranslations(languageCode, 'quick_action_view_map', translationsCache), 'icon': Icons.location_on_outlined},
    ];
                ...
                children: [
                  Row(
                    children: [
                      ...
                      Text(
                        isFullMatch
                            ? '${getTranslations(languageCode, 'match_card_matches_all', translationsCache)} ${matchedNeeds.length} ${getTranslations(languageCode, 'match_card_needs', translationsCache)}'
                            : '${getTranslations(languageCode, 'match_card_matches_partial', translationsCache)} ${matchedNeeds.length} ${getTranslations(languageCode, 'match_card_of', translationsCache)} $totalNeeds ${getTranslations(languageCode, 'match_card_needs', translationsCache)}',
            ...
            child: Row(
              ...
              children: [
                Column(
                  ...
                  children: [
                    Text(
                      getTranslations(languageCode, 'section_hours_contact', translationsCache),
                    ...
                    if (!isExpanded && todayPreview.isNotEmpty) ...[
                      ...
                      Row(
                        children: [
                          Text(
                            getTranslations(languageCode, 'hours_today_label', translationsCache),
                            style: AppTypography.bodySmall.copyWith(
                              color: AppColors.textTertiary,
                            ),
                          ),
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  // Hours table
                  Text(
                    getTranslations(languageCode, 'hours_heading', translationsCache),
                  ...
                  // Contact
                  Text(
                    getTranslations(languageCode, 'contact_heading', translationsCache),
                  ...
                  if (restaurant['phone'] != null)
                    _ContactRow(
                      label: getTranslations(languageCode, 'contact_phone', translationsCache),
                  ...
                  if (restaurant['website'] != null)
                    _ContactRow(
                      label: getTranslations(languageCode, 'contact_website', translationsCache),
                  ...
                  if (restaurant['instagram'] != null)
                    _ContactRow(
                      label: getTranslations(languageCode, 'contact_instagram', translationsCache),
                  ...
                  if (restaurant['booking'] != null)
                    _ContactRow(
                      label: getTranslations(languageCode, 'contact_booking', translationsCache),
            ...
            builder: (context) {
              ...
              return Column(
                children: [
                  ...
                  _FilterSection(
                    title: getTranslations(languageCode, 'menu_filter_dietary_restrictions', translationsCache),
                    subtitle: getTranslations(languageCode, 'menu_filter_dietary_restrictions_desc', translationsCache),
                  ...
                  _FilterSection(
                    title: getTranslations(languageCode, 'menu_filter_dietary_preferences', translationsCache),
                    subtitle: getTranslations(languageCode, 'menu_filter_dietary_preferences_desc', translationsCache),
                  ...
                  _FilterSection(
                    title: getTranslations(languageCode, 'menu_filter_allergens', translationsCache),
                    subtitle: getTranslations(languageCode, 'menu_filter_allergens_desc', translationsCache),
        ...
        children: [
          Padding(
            ...
            child: Column(
              ...
              children: [
                Text(
                  getTranslations(languageCode, 'section_gallery', translationsCache),
                  // Note: JSX uses 18px w680 - using sectionHeading (18px w700)
                  style: AppTypography.sectionHeading,
                ),
          ...
          Center(
            child: TextButton(
              onPressed: onViewAll,
              child: Text(
                getTranslations(languageCode, 'gallery_view_all', translationsCache),
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            ...
            children: [
              Text(
                getTranslations(languageCode, 'section_menu', translationsCache),
                style: AppTypography.sectionHeading,
              ),
              Text(
                getTranslations(languageCode, 'menu_last_updated', translationsCache),
          ...
          TextButton(
            ...
            child: Text(
              filterExpanded
                ? getTranslations(languageCode, 'menu_hide_filters', translationsCache)
                : getTranslations(languageCode, 'menu_show_filters', translationsCache),
            ...
            Container(
              ...
              child: Column(
                children: [
                  ...
                  SizedBox(height: AppSpacing.md),
                  Text(
                    getTranslations(languageCode, 'menu_no_items_heading', translationsCache),
                  ...
                  SizedBox(height: 6),
                  Text(
                    getTranslations(languageCode, 'menu_no_items_desc', translationsCache),
                    style: AppTypography.bodySmall.copyWith(
                      fontWeight: FontWeight.w400,
                      color: AppColors.textTertiary,
                      height: 1.38,
          ...
          if (menuItems.isNotEmpty) ...[
            ...
            Center(
              child: TextButton(
                ...
                child: Text(
                  getTranslations(languageCode, 'menu_view_full_page', translationsCache),
                  style: AppTypography.bodySmall.copyWith(
                    fontWeight: FontWeight.w600,
                    color: AppColors.textSecondary,
                  ),
  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          Text(
            getTranslations(languageCode, 'section_facilities', translationsCache),
            style: AppTypography.sectionHeading,
          ),
          SizedBox(height: AppSpacing.md),
  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          Text(
            getTranslations(languageCode, 'section_payment_options', translationsCache),
            style: AppTypography.sectionHeading,
          ),
          SizedBox(height: AppSpacing.md),
        ...
        children: [
          InkWell(
            ...
            child: Row(
              ...
              children: [
                Text(
                  getTranslations(languageCode, 'section_about', translationsCache),
                  style: AppTypography.sectionHeading,
                ),
                Icon(
                  isExpanded ? Icons.expand_less : Icons.expand_more,
